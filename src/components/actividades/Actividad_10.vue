...
<template>
    <div class="py-6 w-full h-200" id="modal">
        ...
        <a href="https://leetcode.com/problems/search-insert-position/" class="ml-6 text-blue-400 hover:text-blue-500 duration-200" title="Ir a LeetCode"> link LeetCode </a>
        <div class="ml-6 pt-6 space-y-2">
            ...
            <div class="py-4 space-y-3">
                ...
                <Ejemplo entrada="nums = [1,3,5,6], target = 5" salida="2" explicacion="Buscamos dondo colocar 'target' dentro del array 'nums' para mantener un orden ascendente. En este caso posición 2" />
                <h4 class="w-max text-gray-400 border-b border-stone-600">
                    Ejemplo 2
                </h4>
                <Ejemplo entrada="nums = [1,3,5,6], target = 2" salida="1" explicacion="Buscamos dondo colocar 'target' dentro del array 'nums' para mantener un orden ascendente. En este caso posición 1" />
                <h4 class="w-max text-gray-400 border-b border-stone-600">
                    Ejemplo 3
                </h4>
                <Ejemplo entrada="nums = [1,3,5,6], target = 7" salida="4" explicacion="Buscamos dondo colocar 'target' dentro del array 'nums' para mantener un orden ascendente. En este caso posición 4" />

<script setup>
    ...
    import Portafolio from '../icons/Portafolio.vue';
    ...
    <section class="w-full max-w-9/10 sm:max-w-7/10 mx-auto my-12 flex flex-col items-center gap-12" id="aparicion-i2">
        ...
        >
            <div class="flex flex-col items-center justify-center">
                ...
                <small class="text-lg sm:text-3xl text-gray-300/50">Programador Full-Stack</small>
            </div>
            ...
            <div class="absolute -top-2 left-4 flex flex-col sm:flex-row justify-center gap-3 mt-4">
                <a 
                    ...
                    target="_blank" 
                    class="text-gray-500 hover:text-gray-200 font-medium transition-colors"
                    title="Ir a Portafolio de Leonardo Dillon"
                >
                    <Portafolio width="32" height="32"/>
                </a>
                <a 
                    href="https://github.com/leo-dillon/" 
                    target="_blank" 
                    class="text-gray-500 hover:text-gray-200 font-medium transition-colors"
                    title="Ir a Github de Leonardo Dillon"
                >
                    <Github width="32" height="32" />
                </a>
                <a 
                    href="https://www.linkedin.com/in/leonardo-dillon-jeannoteguy-1878b515a/" 
                    target="_blank" 
                    class="text-gray-500 hover:text-gray-200 font-medium transition-colors"
                    title="Ir a Linkedin de Leonardo Dillon"
                >
                    <Linkendin width="32" height="32"/>
                </a>
                </div>
        </div>
    </section>
